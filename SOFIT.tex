...
\noindent where $w_i$ is the underline true variable we intend to solve; $Y_i$ is the measurement of $w_i$. We model the difference of $w_i$ and $Y_i$, $m_Y$, as an i.i.d. noise process in zeros-mean Gaussian distribution. This model penalizes excessive transformation due to over-fitting. The joint probability of all variables can be written as
